...
earthquakeCatalog = {
  <|"Name" -> "2025 Myanmar M7.7",
    ...
    "Position" -> GeoPosition[{22.011, 95.936}],
    "Depth" -> 10, (* km *)
    "Year" -> 2025,
  ...
  <|"Name" -> "2026 Venezuela M7.5",
    ...
    "Position" -> GeoPosition[{10.435, -68.472}],
    "Depth" -> 10,
    "Year" -> 2026,
    "Mechanism" -> "Strike-Slip",
    "Strike" -> 90, "Dip" -> 85, "Rake" -> 175,
    "FaultName" -> "San Sebastian Fault",
    "Notes" -> "Twin quakes M7.2+M7.5 separated by 38 seconds (USGS us6000t7zc/t7zp)"|>,

  <|"Name" -> "2025 Crete M6.0",
    "ShortName" -> "Crete 2025",
    "Magnitude" -> 6.0, "MagnitudeType" -> "Mw",
    "Position" -> GeoPosition[{35.237, 26.995}],
    "Depth" -> 76,
    "Year" -> 2025,
    "Mechanism" -> "Normal",
